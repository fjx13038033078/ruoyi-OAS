...
--
-- Host: localhost    Database: ry-ape
-- ------------------------------------------------------
...
INSERT INTO `ape_activity` VALUES (1,'aaa','北京','aaahh','2025-01-07 08:00:00','2025-01-10 20:00:00','1'),(2,'不不不','西安','内容','2025-01-06 11:06:11','2025-01-08 00:00:00','1'),(3,'冲冲冲','人人','二人','2025-01-06 11:06:32','2025-01-25 00:00:00','1'),(4,'达到','达到','达到','2025-01-06 11:06:50','2025-01-10 00:00:00','1');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动报名表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_activity_registration` VALUES (11,2,1,'2025-01-06 17:40:26',1),(12,3,1,'2025-01-06 17:40:01',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='古诗词评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_comment` VALUES (2,1,1,'真不错','2025-01-03 11:00:59'),(3,7,1,'好啊','2025-01-07 09:57:42');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='问题反馈表\nsql\n复制代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_feedback` VALUES (1,1,'阿萨德',1,NULL,'2025-01-03 15:19:53'),(3,1,'阿萨德',1,'好好','2025-01-03 15:22:27'),(4,1,'振的',0,NULL,NULL);
...
CREATE TABLE `ape_poem` (
  ...
  PRIMARY KEY (`poem_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='古诗词表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_poem` VALUES (1,1,'实时','实时','实时111',1,'是是是',NULL),(5,1,'方法','方法','范',0,'GG',NULL),(6,103,'渭城曲','王维','渭城朝雨浥轻尘，客舍青青柳色新。\n劝君更尽一杯酒，西出阳关无故人。',1,'',NULL),(8,1,'都','都','都',1,'都','/profile/upload/2025/01/07/1_20250107145700A002.pdf'),(9,1,'1','1','1',0,'1','/profile/upload/2025/01/07/1_20250107144629A001.pdf'),(10,107,'赠汪伦','李白','李白乘舟将欲行，忽闻岸上踏歌声。桃花潭水深千尺，不及汪伦送我情。',1,'唐朝',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='交易记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场地信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='羽毛球场预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场地评价表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cfcr_review` VALUES (1,1,3,NULL,'2024-03-02 22:42:02'),(2,1,3,NULL,'2024-03-02 22:43:59'),(5,1,3,'真不多','2024-03-02 23:35:11'),(8,1,6,'真不错','2024-03-26 16:10:58');
...
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=219 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-01-07 15:45:10','普通用户');
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-01-07 16:35:07','admin','2024-02-28 22:23:42','','2025-01-07 16:35:06','管理员',390.00),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','',NULL,'admin','2024-03-04 18:58:34','admin','2024-03-08 10:19:23',NULL,10.00),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','',NULL,'admin','2024-03-04 18:58:57','admin','2024-03-08 10:19:28',NULL,10.00),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2024-03-11 11:02:02','admin','2024-03-04 18:59:22','admin','2024-03-11 11:02:02',NULL,9610.00),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2025-01-06 16:58:03','admin','2024-03-04 18:59:55','admin','2025-01-06 16:58:03',NULL,10000.00),(104,NULL,'fanjiaxing','fanjiaxing','00','','','0','','$2a$10$eyzwvhBbnWSUIf8.AxTXJONb9j/WV3c3s2oUiSCTmUhe.iN6eQdVK','0','2','127.0.0.1','2024-03-18 10:21:10','','2024-03-18 10:20:59','','2024-03-18 10:21:10',NULL,NULL),(105,NULL,'fanjiaxing','fanjiaxing','00','','','0','','$2a$10$dQhzINJKANvGEgCekejN2.SI6sJomoBbiX5tmi.msdmhHVP9rk0ou','0','0','',NULL,'','2024-03-18 11:09:21','admin','2025-01-07 09:56:43',NULL,NULL),(106,NULL,'张夜猫','张夜猫','00','','','0','','$2a$10$5eh4CwLns/GDKDBorKQA2uAsjQAswonnvsEVGJ7FopP3.YdPyD5iC','0','2','127.0.0.1','2025-01-07 09:56:09','','2024-12-30 17:22:08','','2025-01-07 09:56:08',NULL,NULL),(107,NULL,'fjx3205073','fjx3205073','00','','','0','','$2a$10$UIZXJBYjXD5y4YxO/6qqd.ExJAy.Ln3LBSdZSs13RTCM7pL2.B8Gq','0','0','127.0.0.1','2025-01-07 15:58:13','','2024-12-31 09:23:15','admin','2025-01-07 15:58:13',NULL,NULL);
...
INSERT INTO `sys_user_role` VALUES (1,1),(100,2),(101,2),(102,100),(103,101),(105,101),(107,101);
/*!40000 ALTER TABLE `sys_user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'ry-ape'
--
...
-- Dump completed on 2025-01-07 16:43:18
