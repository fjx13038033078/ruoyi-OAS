...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='活动报名表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_activity_registration` VALUES (9,4,1,'2025-01-06 16:44:48',0),(10,1,1,'2025-01-06 15:45:30',0),(11,2,1,'2025-01-06 16:01:37',0),(12,3,1,'2025-01-06 16:44:56',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='古诗词评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_comment` VALUES (2,1,1,'真不错','2025-01-03 11:00:59');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='问题反馈表\nsql\n复制代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_feedback` VALUES (1,1,'阿萨德',1,NULL,'2025-01-03 15:19:53'),(3,1,'阿萨德',1,'好好','2025-01-03 15:22:27');
...
CREATE TABLE `ape_poem` (
  ...
  PRIMARY KEY (`poem_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='古诗词表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_poem` VALUES (1,1,'实时','实时','实时111',1,'是是是'),(5,1,'方法','方法','范',0,'GG'),(6,103,'渭城曲','王维','渭城朝雨浥轻尘，客舍青青柳色新。\n劝君更尽一杯酒，西出阳关无故人。',1,'');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2036 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=200 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-01-06 16:52:44','普通用户');
...
INSERT INTO `sys_user_role` VALUES (1,1),(100,2),(101,2),(102,100),(103,101),(107,4);
...
-- Dump completed on 2025-01-06 17:12:03
