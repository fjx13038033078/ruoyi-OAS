...
--
-- Table structure for table `oas_point`
--

DROP TABLE IF EXISTS `oas_point`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oas_point` (
  `point_id` bigint NOT NULL AUTO_INCREMENT COMMENT '节点ID',
  `point_name` varchar(100) NOT NULL COMMENT '节点名称',
  `user_name` varchar(100) NOT NULL COMMENT '操作人',
  `point_next` bigint DEFAULT NULL COMMENT '下一节点',
  `point_back` bigint DEFAULT NULL COMMENT '退回节点',
  PRIMARY KEY (`point_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工作流节点';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oas_point`
--

LOCK TABLES `oas_point` WRITE;
/*!40000 ALTER TABLE `oas_point` DISABLE KEYS */;
INSERT INTO `oas_point` VALUES (1,'总经理审批','zhangsan',NULL,2),(2,'部门经理审批','lisi',3,1),(3,'发起申请','wangwu',2,NULL);
/*!40000 ALTER TABLE `oas_point` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_notice` VALUES (1,'欢迎大家使用','2',_binary '<p>系统开放，欢迎大家使用</p>','0','admin','2024-02-28 22:23:43','admin','2025-03-04 16:02:39','管理员'),(2,'平台系统维护','1',_binary '<p>系统维护中，两天后正常开放</p>','0','admin','2024-02-28 22:23:43','admin','2025-03-04 16:02:17','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=380 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-04 16:03:46
