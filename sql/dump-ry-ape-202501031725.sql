...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='古诗词交流活动';
...
INSERT INTO `ape_activity` VALUES (1,'aaa','北京','aaahh','2025-01-07 08:00:00','2025-01-10 20:00:00','1');
...
CREATE TABLE `ape_poem` (
  ...
  PRIMARY KEY (`poem_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='古诗词表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ape_poem` VALUES (1,1,'实时','实时','实时111',1,'是是是'),(5,1,'方法','方法','范',0,'GG');
...
) ENGINE=InnoDB AUTO_INCREMENT=193 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-03 17:25:39
